...
const links = [["All policies", "/legal"], ["Terms", "/legal/terms"], ["Privacy", "/legal/privacy"], ["Refunds", "/legal/refunds"], ["Domains", "/legal/domains"], ["Accessibility", "/legal/accessibility"], ["Security", "/legal/security"], ["Contact", "/contact"]] as const;
