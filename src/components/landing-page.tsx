    ...
    <main id="top" className="overflow-hidden bg-[#e7ecdf] text-[#302821]">
      ...
      <section className="eventloom-hero relative isolate -mt-[4.25rem] flex min-h-svh items-center overflow-hidden px-5 py-20 text-white sm:px-8 sm:py-24">
        ...
        <div className="eventloom-hero-content relative mx-auto flex w-full max-w-4xl -translate-y-[2vh] flex-col items-center text-center">
          <h1 className="mx-auto mt-4 text-[48px] font-semibold leading-[1.1] tracking-[-0.045em]"><span className="block">Create a beautiful</span><span className="block">event website with RSVPs</span></h1>
          <p className="mt-4 text-[13px] font-medium uppercase tracking-[0.18em] text-white/60">Online RSVP websites for weddings, birthdays, and private events</p>
          <p className="mt-5 max-w-xl text-base leading-7 text-white/70">Build a polished event website, share one simple link with guests, and keep every RSVP, dietary note, and party detail organized in one place.</p>
      ...
      <section id="product" className="scroll-mt-24 border-y border-[#48686a]/15 px-5 py-16 sm:px-8 sm:py-24"><div className="mx-auto max-w-6xl"><div className="mx-auto mb-10 max-w-2xl text-center sm:mb-14"><p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-[#8a6153]">Made for the moment</p><h2 className="mt-4 font-[family-name:var(--font-playfair)] text-4xl leading-[0.95] tracking-[-0.055em] sm:text-5xl">Your event website, details, and RSVPs in one place.</h2></div><EventloomShowcase /></div></section>
