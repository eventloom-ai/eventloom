...
export function AccountDataControls() {
  ...
  return <section className="mt-8 rounded-2xl border border-black/10 bg-white p-6 shadow-sm">
    ...
    <div className="mt-5 flex flex-wrap gap-3">
      <Link href="/api/account" className="inline-block rounded-full border border-black/15 px-5 py-3 text-sm font-semibold">Download account export</Link>
      <Link href="/privacy/request" className="inline-block rounded-full border border-black/15 px-5 py-3 text-sm font-semibold">Submit a privacy request</Link>
    </div>
